...
Hard          = [        'Hard', 12,   70, 1.5] # 6
VertHard      = [    'VertHard', 15,   75, 1.6] # 7
Danger        = [      'Danger', 15,   80, 1.7] # 7

# 맵 리스트   = [                               맵 이름,       표시상 난이도, 티어(Idx), 선택 가능한 난이도 시작(Idx), 끝]
AbndFctr      = [       'Abandoned Factory:버려진 공장',     'Stable:안정적', 0,  0,  2]
ArdnBtfd      = [  'Ardennes Battlefield:아르덴 교전지',   'Low-Risk:저위험', 0,  1,  3]
NO_AfrcFrnt   = [  'North-Africa Front:북아프리카 전선',  'Caution:주의필요', 1,  1,  4]
NrmdFild      = [       'Normandy Fields:노르망디 들판', 'Unstable:불안정됨', 1,  2,  5]
Btle_Aras     = [       'Battle of Arras:아라스 전차전',  'High-Risk:고위험', 2,  3,  6]
BrlnAtck      = [           'Berlin Attack:베를린 공습',  'High-Risk:고위험', 2,  4,  7]
